...
public class NativeDownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTitleTextView.setText("Native Download");
    ...
    private class NativeDownloadAdapter extends RecyclerView.Adapter<NativeDownloadViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final NativeDownloadViewHolder nativeDownloadViewHolder, final int i) {
            ...
            if (downloadBean.getTotalsLength() > 0L) {
                ...
                nativeDownloadViewHolder.mCurrentProgress.setText("Current progress: " + byte2FitMemorySize(downloadBean.getLoaded()) + "/" + byte2FitMemorySize(downloadBean.getTotalsLength()) + " Time: " + ((downloadBean.getUsedTime()) / 1000) + "s");
            } else {
                nativeDownloadViewHolder.mProgressBar.setProgress(0);
                nativeDownloadViewHolder.mCurrentProgress.setText("Current progress, downloaded: " + byte2FitMemorySize(downloadBean.getLoaded()) + " Time: " + ((downloadBean.getUsedTime()) / 1000) + "s");
            }
            Log.e(TAG, "status:" + downloadBean.getStatus() + " position:" + i);
            if (downloadBean.getStatus() == DownloadTask.STATUS_NEW) {
                nativeDownloadViewHolder.mStatusButton.setText("Start");
            } else if (downloadBean.getStatus() == DownloadTask.STATUS_PENDDING) {
                nativeDownloadViewHolder.mStatusButton.setText("Waiting...");
                nativeDownloadViewHolder.mStatusButton.setEnabled(false);
            } else if (downloadBean.getStatus() == DownloadTask.STATUS_PAUSED) {
                nativeDownloadViewHolder.mStatusButton.setText("Resume");
            } else if (downloadBean.getStatus() == DownloadTask.STATUS_DOWNLOADING) {
                nativeDownloadViewHolder.mStatusButton.setText("Pause");
            } else if (downloadBean.getStatus() == DownloadTask.STATUS_CANCELED || downloadBean.getStatus() == DownloadTask.STATUS_ERROR) {
                nativeDownloadViewHolder.mStatusButton.setText("Error");
                nativeDownloadViewHolder.mStatusButton.setEnabled(false);
            } else {
                nativeDownloadViewHolder.mStatusButton.setText("Completed");
                nativeDownloadViewHolder.mStatusButton.setEnabled(false);
            }
            ...
            downloadBean.setDownloadListenerAdapter(new DownloadListenerAdapter() {
                ...
                @MainThread // Callback to main thread, add this annotation
                @Override
                public void onProgress(String url, long downloaded, long length, long usedTime) {
                    ...
                    nativeDownloadViewHolder.mProgressBar.setProgress(mProgress);
                    if (length <= 0) {
                        nativeDownloadViewHolder.mCurrentProgress.setText("Current progress, downloaded: " + byte2FitMemorySize(downloaded) + " Time: " + ((downloadBean.getUsedTime()) / 1000) + "s");
                    } else {
                        nativeDownloadViewHolder.mCurrentProgress.setText("Current progress: " + byte2FitMemorySize(downloaded) + "/" + byte2FitMemorySize(length) + " Time: " + ((downloadBean.getUsedTime()) / 1000) + "s");
...
//        canvas.drawRoundRect(rectF, widthLight / 5, heightLight / 5, paintColor);
    ...
    public void createDatasource() {
        ...
        downloadBean = new DownloadBean("Tencent Video", "http://p18.qhimg.com/dr/72__/t013d31024ae54d9c35.png", "http://shouji.360tpcdn.com/170918/f7aa8587561e4031553316ada312ab38/com.tencent.qqlive_13049.apk");
        downloadBean.setContext(this.getApplicationContext());
        mDownloadTasks.add(downloadBean);

        downloadBean = new DownloadBean
apk&hsr=4d5s&cip=120.231.209.169&proto=https");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.setEnableIndicator(false);
        downloadBean.setQuickProgress(true);
        mDownloadTasks.add(downloadBean);
        ...
        downloadBean = new DownloadBean("Zhongyuan Consumer Finance", "https://pp.myapp.com/ma_pic2/0/shot_52471681_2_1565161792/550", "https://f437b8a1a8be40951a91f58666e659d0.dd.cdntips.com/wxz.myapp.com/16891/apk/B1C6CC0DB7D412DA47A3A446E28D9C09.apk?mkey=5d5014fb78e7f75c&f=24c5&fsname=com.hnzycfc.zyxj_3.0.1_52.apk&hsr=4d5s&cip=120.231.209.169&proto=https");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.setEnableIndicator(false);
        downloadBean.setQuickProgress(true);
        mDownloadTasks.add(downloadBean);
        ...
        downloadBean = new DownloadBean("Store Manager Direct Hire", "https://pp.myapp.com/ma_icon/0/icon_12216213_1564373730/96", "https://f437b8a1a8be40951a91f58666e659d0.dd.cdntips.com/wxz.myapp.com/16891/apk/FA29D09A6CD550DCBEBC1D89EA392109.apk?mkey=5d5014b478e7f75c&f=1849&fsname=com.hpbr.directhires_4.31_403010.apk&hsr=4d5s&cip=120.231.209.169&proto=https");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.setEnableIndicator(false);
        downloadBean.setQuickProgress(true);
        mDownloadTasks.add(downloadBean);
        ...
        downloadBean = new DownloadBean("Coupon Bar", "https://pp.myapp.com/ma_icon/0/icon_42320744_1564583832/96", "https://11473001bb572df6cb60e7e0821a4586.dd.cdntips.com/wxz.myapp.com/16891/apk/4AA997287EEA4A96C2DFD97CEE0180AD.apk?mkey=5d50148f78e7f75c&f=24c5&fsname=com.ciyun.oneshop_7.07_69.apk&hsr=4d5s&cip=120.231.209.169&proto=https");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.setEnableIndicator(false);
        downloadBean.setQuickProgress(true);
        mDownloadTasks.add(downloadBean);
        ...
        downloadBean = new DownloadBean("360 IOU", "https://pp.myapp.com/ma_icon/0/icon_42379225_1564124706/96", "https://e2983106ebfb9f560ff3a8e230faa981.dd.cdntips.com/wxz.myapp.com/16891/apk/DEB654116EC627ABA4DB12A6E777EAAD.apk?mkey=5d5015d578e7f75c&f=1026&fsname=com.qihoo.loan_1.5.4_213.apk&hsr=4d5s&cip=120.231.209.169&proto=https");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.setEnableIndicator(false);
        downloadBean.setQuickProgress(true);
        mDownloadTasks.add(downloadBean);
        ...
        downloadBean = new DownloadBean("Taobao", "https://pp.myapp.com/ma_icon/0/icon_5080_1564463763/96", "http://shouji.360tpcdn.com/170901/ec1eaad9d0108b30d8bd602da9954bb7/com.taobao.taobao_161.apk");
        downloadBean.setContext(this.getApplicationContext());
        mDownloadTasks.add(downloadBean);

        //http://www.httpwatch.com/httpgallery/chunked/chunkedimage.aspx?0.04400023248109086

        downloadBean = new DownloadBean("Chunked Transfer, Image", "http://www.httpwatch.com/httpgallery/chunked/chunkedimage.aspx?0.04400023248109086", "http://www.httpwatch.com/httpgallery/chunked/chunkedimage.aspx?0.04400023248109086");
        downloadBean.setContext(this.getApplicationContext());
        downloadBean.autoOpenIgnoreMD5();
        mDownloadTasks.add(downloadBean);


        downloadBean = new DownloadBean("YeAi Live", "https://pp.myapp.com/ma_icon/0/icon_10472625_1555686747/96", "https://a46fefcd092f5f917ed1ee349b85d3b7.dd.cdntips.com/wxz.myapp.com/16891/F9B7FA7EC195FC453AE9082F826E6B28.apk?mkey=5d4c6bdc78e5058d&f=1806&fsname=com.tiange.hz.paopao8_4.4.1_441.apk&hsr=4d5s&cip=120.229.35.120&proto=https");
        downloadBean.setContext(this.getApplicationContext());
